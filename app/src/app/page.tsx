  ...
  const executiveCockpit = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <KPICard title="Production Output" value={kpiVal('Production Output', '12.4M pcs')} status="neutral" />
        <KPICard title="Line Efficiency" value={kpiVal('Line Efficiency', '84%')} status="neutral" />
        <KPICard title="Quality Pass Rate" value={kpiVal('Quality Pass Rate', '97.2%')} status="neutral" />
        <KPICard title="Workers Active" value={kpiVal('Workers Active', '8,400')} status="neutral" />
      </div>
  ...
  const domainTab1 = (
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        <KPICard title="SAM Achievement" value={kpiVal('SAM Achievement', '92%')} />
        <KPICard title="Changeover Time" value={kpiVal('Changeover Time', '2.4 hrs')} />
        <KPICard title="Absenteeism" value={kpiVal('Absenteeism', '4.8%')} />
      </div>
      <Chart
